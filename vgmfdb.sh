...
ext_sap="sap"
ext_spc="spc"
ext_tracker_openmpt="it|dsm|mod|mo3|mptm|s3m|stm|stp|plm|umx|xm"
...
ext_vgm="vgm|vgz"
ext_vgmstream_0_c="22k|8svx|aax|acb|acm|ad|ads|adp|adpcm|adx|aix|akb|asf|apc|at3|at9|awb|bcstm|bcwav|bfstm|bfwav|bik|brstm|bwav|cfn|ckd|cmp|csa|csb|csmp|cps"
ext_vgmstream_d_n="dsp|dvi|fsb|gcm|genh|h4m|hca|hps|ifs|imc|int|isd|ivs|kma|ks|kvs|lac3|lbin|lmp3|logg|lopus|lrmh|lstm|lwav|mab|mca|mic|msf|mus|musx|nlsd|nop|npsf"
ext_vgmstream_o_z="ogv|oma|ras|rsd|rsnd|rws|sad|sap|scd|sfx|sgd|snd|ss2|str|strm|stx|svag|p04|p08|p16|pcm|psb|thp|trk|trs|txtp|ulw|vag|vas|vds|vgmstream|vig|voi|way|wem|xa|xai|xma|xmd|xnb|xvag|xwv"
